...
def _execute(filters=None, additional_table_columns=None, additional_query_columns=None):
	...
	for d in item_list:
		...
		row = [d.item_code, d.item_name, d.item_group, d.parent, d.posting_date, d.due_date, d.supplier,
			d.supplier_name]
		...
		row += [
			d.credit_to, d.company, d.purchase_order,
...
def get_columns(additional_table_columns):
	...
	columns += [
		...
		# _("Mode of Payment") + ":Link/Mode of Payment:140", _("Project") + ":Link/Project:80",
		_("Company") + ":Link/Company:100", _("Purchase Order") + ":Link/Purchase Order:140",
		_("Purchase Receipt") + ":Link/Purchase Receipt:140", _("Expense Account") + ":Link/Account:140",
