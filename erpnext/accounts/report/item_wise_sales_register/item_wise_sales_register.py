...
def _execute(filters=None, additional_table_columns=None, additional_query_columns=None):
    ...
    for d in item_list:
        ...
        row = [d.item_code, d.item_name, d.item_group, d.parent, d.posting_date, d.date_issuance, d.date_supply,
...
def get_columns(additional_table_columns):
    columns = [
        ...
        _("Posting Date") + ":Date:80", _("Date of Issuance") + ":Date:100", _("Date of Supply") + ":Date:100",
...
def get_items(filters, additional_query_columns):
    ...
    return frappe.db.sql("""
		select
			...
			`tabSales Invoice`.date_issuance,
			`tabSales Invoice`.date_supply,
