...
def _execute(filters, additional_table_columns=None, additional_query_columns=None):
	...
	for inv in invoice_list:
		...
		row = [
			inv.name, inv.posting_date,inv.date_issuance,inv.date_supply, inv.customer, inv.customer_name
		]
...
def get_columns(invoice_list, additional_table_columns):
	...
	columns = [
		...
		_("Date of Issuance")+":Date:100", _("Date of Supply")+":Date:100",
...
def get_invoices(filters, additional_query_columns):
	...
	return frappe.db.sql("""select name, posting_date, date_issuance, date_supply, debit_to, project, customer, customer_name, remarks,
