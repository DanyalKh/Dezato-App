...
error_report_email = "support@uaepos.com"
...
standard_portal_menu_items = [
    ...
    {"title": _("Request for Quotations"), "route": "/rfq", "reference_doctype": "Request for Quotation",
     "role": "Supplier"},
    {"title": _("Supplier Quotation"), "route": "/supplier-quotations", "reference_doctype": "Supplier Quotation",
     "role": "Supplier"},
...
doc_events = {
    ...
    "Payment Entry": {
        ...
        "on_update": "erpnext.accounts.for_gle_2"
    },
    'Address': {
